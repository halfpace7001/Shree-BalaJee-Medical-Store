...
export default function PrescriptionUpload() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    const msg = encodeURIComponent(
      ...
      `Name: ${form.name}\n` +
      `Phone: ${form.phone}\n` +
      `Prescription: ${fileName ? `[Will attach: ${fileName}]` : "Will share in chat"}\n` +
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <button
                  ...
                  className={`w-full border-2 border-dashed rounded-2xl py-6 flex flex-col items-center gap-3 transition-all ${
                    file
                  ...
                  {file ? (
                    <>
                      ...
                      <div className="text-center">
                        <p className="text-green-700 dark:text-green-400 font-black text-sm">{fileName}</p>
                        <p className="text-green-500 text-xs mt-0.5">Tap to change</p>
                      </div>
                    </>
                  ) : (
                    <>
                      ...
                      <div className="text-center">
                        <p className="text-gray-700 dark:text-gray-300 font-semibold text-sm">Click to upload prescription</p>
                        <p className="text-gray-400 text-xs mt-0.5">JPG, PNG or PDF — max 10 MB</p>
                      </div>
                    </>
                  )}
                </button>
                ...
                {file && (
                  <p className="text-amber-500 text-xs mt-2 flex items-center gap-1.5">
                    <Paperclip className="w-3.5 h-3.5" />
                    After submitting, attach this file manually in WhatsApp using the 📎 icon.
                  </p>
                )}
              </div>
